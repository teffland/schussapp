...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'members_membertype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member_type', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('type_abbr', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ))
        db.send_create_signal(u'members', ['MemberType'])

        # Adding model 'Price'
        db.create_table(u'members_price', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.MemberType'])),
            ('start_date', self.gf('django.db.models.fields.DateField')()),
            ('end_date', self.gf('django.db.models.fields.DateField')()),
            ('price', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'members', ['Price'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'members_membertype')

        # Deleting model 'Price'
        db.delete_table(u'members_price')
