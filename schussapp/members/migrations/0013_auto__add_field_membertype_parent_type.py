...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberType.parent_type'
        db.add_column(u'members_membertype', 'parent_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['members.MemberType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberType.parent_type'
        db.delete_column(u'members_membertype', 'parent_type_id')
